...
| `woaile-gzh-imagegen` | self-developed | 「我AI了」公众号专属风格生图工具（品牌四色+吉祥物「小爱」+封面标题内嵌+品牌化表格+手绘笔记本风知识科普图解，输出提示词供用户浏览器生图） |
...
AGENTS.global.md 通过文件级符号链接服务于 OpenCode，为所有项目提供统一的代理行为规则：
