...
|---|---|---|
| `analysis/image_analysis.csv` | Current `images/` | `uv run python ${SKILL_DIR}/scripts/analyze_images.py <project_path>/images` |
| `notes/slide_*.md` | `notes/total.md` | `uv run python ${SKILL_DIR}/scripts/total_md_split.py <project_path>` |
| `svg_final/` | `svg_output/` plus project assets | `uv run python ${SKILL_DIR}/scripts/finalize_svg.py <project_path>` |
| Native PPTX | `svg_output/` plus notes/assets | `uv run python ${SKILL_DIR}/scripts/svg_to_pptx.py <project_path>` |
