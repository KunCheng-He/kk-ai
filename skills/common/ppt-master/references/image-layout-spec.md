...
```bash
uv run python scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
uv run python scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
uv run python scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
