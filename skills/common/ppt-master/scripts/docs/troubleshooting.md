...
```bash
uv run python scripts/notes_to_audio.py <project_path> --voice zh-CN-XiaoxiaoNeural
uv run python scripts/svg_to_pptx.py <project_path> --recorded-narration audio
```
