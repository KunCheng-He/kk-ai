...
3. Validate: `uv run python skills/ppt-master/scripts/svg_quality_checker.py templates/layouts/<id> --template-mode --format ppt169`
4. Register: `uv run python skills/ppt-master/scripts/register_template.py <id> --kind layout`
