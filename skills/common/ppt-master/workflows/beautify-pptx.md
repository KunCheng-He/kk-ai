...
```bash
uv run python ${SKILL_DIR}/scripts/project_manager.py init <project_name> --format <format>
uv run python ${SKILL_DIR}/scripts/project_manager.py import-sources <project_path> <source.pptx> --move
```
...
```bash
uv run python ${SKILL_DIR}/scripts/pptx_intake.py <project_path>/sources/<source.pptx> -o <project_path>/analysis
```
...
```bash
uv run python ${SKILL_DIR}/scripts/pptx_to_svg.py <project_path>/sources/<source.pptx> -o <project_path>/analysis/source_svg_import
uv run python ${SKILL_DIR}/scripts/extract_svg_assets.py <project_path>/analysis/source_svg_import/svg-flat \
...
```bash
uv run python ${SKILL_DIR}/scripts/beautify_inventory.py <project_path>/analysis/<stem>.slide_library.json \
...
```bash
uv run python ${SKILL_DIR}/scripts/confirm_ui/server.py <project_path> --daemon --wait
```
...
```bash
uv run python ${SKILL_DIR}/scripts/finalize_svg.py <project_path>
uv run python ${SKILL_DIR}/scripts/svg_to_pptx.py <project_path>
```
...
```bash
uv run python ${SKILL_DIR}/scripts/source_to_md/ppt_to_md.py <project_path>/exports/<output.pptx>
```
