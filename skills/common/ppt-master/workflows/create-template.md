...
```bash
uv run python skills/ppt-master/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
uv run python skills/ppt-master/scripts/extract_svg_assets.py "<import_workspace>/svg" --icons-dir "<import_workspace>/icons" --inplace --id-prefix layered --min-decoration-bytes 3000 --clean-stale

# mirror creation path
uv run python skills/ppt-master/scripts/extract_svg_assets.py "<import_workspace>/svg-flat" --icons-dir "<import_workspace>/icons" --inplace --id-prefix flat --min-decoration-bytes 3000 --clean-stale
```
...
```bash
uv run python skills/ppt-master/scripts/extract_svg_assets.py "<svg_analysis_workspace>/svg" --icons-dir "<svg_analysis_workspace>/icons" --inplace --id-prefix source --min-decoration-bytes 3000 --clean-stale
```
...
```bash
uv run python skills/ppt-master/scripts/svg_quality_checker.py "skills/ppt-master/templates/<kind_dir>/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
# For deck (default)
uv run python skills/ppt-master/scripts/register_template.py <template_id> --kind deck

# For layout
uv run python skills/ppt-master/scripts/register_template.py <template_id> --kind layout
```
...
>
> ```bash
> uv run python skills/ppt-master/scripts/register_template.py --kind deck --rebuild-all
> uv run python skills/ppt-master/scripts/register_template.py --kind layout --rebuild-all
> ```
