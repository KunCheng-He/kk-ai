...
```bash
uv run python skills/ppt-master/scripts/native_enhance_pptx.py init "<source.pptx>" --name "<project_slug>"
```
...
```bash
uv run python skills/ppt-master/scripts/native_enhance_pptx.py plan "<project>"
```
...
```bash
uv run python skills/ppt-master/scripts/native_enhance_pptx.py validate "<project>"
```
...
```bash
uv run python skills/ppt-master/scripts/notes_to_audio.py "<project>" \
...
```bash
uv run python skills/ppt-master/scripts/native_enhance_pptx.py apply "<project>"
```
...
```bash
uv run python skills/ppt-master/scripts/source_to_md/ppt_to_md.py \
