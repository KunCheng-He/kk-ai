...
5. Run the matching calculator command:
   ...
   uv run python skills/ppt-master/scripts/svg_position_calculator.py calc bar \
   ...
   uv run python skills/ppt-master/scripts/svg_position_calculator.py calc line \
   ...
   uv run python skills/ppt-master/scripts/svg_position_calculator.py calc pie \
   ...
   uv run python skills/ppt-master/scripts/svg_position_calculator.py calc radar \
...
```bash
uv run python skills/ppt-master/scripts/svg_quality_checker.py <project_path>
```
...
```bash
uv run python skills/ppt-master/scripts/total_md_split.py <project_path>
uv run python skills/ppt-master/scripts/finalize_svg.py <project_path>
